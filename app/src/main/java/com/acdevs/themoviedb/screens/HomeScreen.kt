...
fun HomeScreen(viewModel: HomeViewModel,
    ...
    Column(
        ...
        TopRatedMovies(topRatedMoviesList = topRatedMoviesData.value?.results ?: emptyList())
    }
...
@Composable
fun TopRatedMovies(modifier: Modifier = Modifier, topRatedMoviesList: List<Results>) {
